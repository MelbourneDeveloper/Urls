...
namespace Urls
{
    ...
    )
    {
        ...
        public AbsoluteUrl(
            ...
            string host,
            int? port = null,
            RelativeUrl? requestUri = null
        )
            : this(scheme, host, port, requestUri ?? RelativeUrl.Empty, UserInfo.Empty) { }

        public AbsoluteUrl(AbsoluteUrl absoluteUrl)
        {
            absoluteUrl ??= Empty;
...
#pragma warning disable CA1054 // URI-like parameters should not be strings
        public AbsoluteUrl(string uriString)
            : this(new Uri(uriString).ToAbsoluteUrl())
#pragma warning restore CA1054 // URI-like parameters should not be strings
        ...
        public static implicit operator Uri(AbsoluteUrl absoluteUrl) =>
            absoluteUrl == null ? Empty : new Uri(absoluteUrl.ToString());
